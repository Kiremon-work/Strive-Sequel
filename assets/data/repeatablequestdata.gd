...
#	},
	...
	fighters_dungeon_easy = {
		...
		randomconditions = [{code = 'complete_dungeon', type = ['dungeon_bandit_den', 'dungeon_goblin_cave','spider_lair']}],
		unlockreqs = [],
		reputation = [150,250],
	...
	fighters_dungeon_medium = {
		...
		name = tr("FIGHTERS_DUNGEON_NAME"),
		descript = tr("FIGHTERS_DUNGEON_DESC"),
		randomconditions = [{code = 'complete_dungeon', type = ['dungeon_bandit_fort','dungeon_undead_crypt','dungeon_ancient_jungles','rebel_redoubt','grove']}],
		unlockreqs = [],
		reputation = [200,350],
	...
	fighters_dungeon_hard = {
		...
		name = tr("FIGHTERS_DUNGEON_NAME"),
		descript = tr("FIGHTERS_DUNGEON_DESC"),
		randomconditions = [{code = 'complete_dungeon', type = ['dungeon_fire_depths','dungeon_ancient_jungles','goblin_stronghold']}],
		unlockreqs = [],
		reputation = [300,500],
